		...
		return (
			<nav className="navbar navbar-expand-lg navbar-light bg-light rounded">
				<div className="container">
					<IndexLink to="/product-cart" className="navbar-brand">
						LogoCompany
					</IndexLink>
					<button
					...
					<div className="collapse navbar-collapse" id="navbarsExample09">
						<ul className="navbar-nav mr-auto">
							<li className="nav-item">
								<IndexLink to="/product-cart" className="nav-link" activeClassName="on">Index</IndexLink>
							</li>
							<li className="nav-item">
						...
						<span className="form-inline my-2 my-lg-0">
							<ul className="nav profile-widget">
								<li>
									<Link to="/product-cart/cart" activeClassName="on" className="nav-link">
										Cart
